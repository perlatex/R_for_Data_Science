...
R语言是统计编程的第一语言，近几年Tidyverse的推出大大降低了R语言的学习难度。Tidyverse是一系列R包的集合，包含了dplyr、ggplot2、tidyr、stringr等，从数据导入预处理，再到高级转化、可视化、建模和展示。因为其代码清晰可读的编程风格，得到越来越多人的喜爱。文中大量使用形象化的比喻，从计算机科学的角度来讲，这些比喻是不严谨的，但是可以帮助大家理解其中概念，激励动手操作，提升信心。因为我们的目的，是让大家不害怕编程，而不是把大家培养成程序员。
