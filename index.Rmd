...
- 应用篇
   - 第 \@ref(eda-nobel) 章介绍探索性数据分析1   
   - 第 \@ref(eda-olympics) 章介绍探索性数据分析2   
   - 第 \@ref(eda-covid2019) 章介绍探索性数据分析3   
   - 第 \@ref(eda-anscombe) 章介绍探索性数据分析4   
   - 第 \@ref(eda-height) 章介绍探索性数据分析5   
   - 第 \@ref(eda-caribou) 章介绍探索性数据分析6   
   - 第 \@ref(eda-penguins) 章介绍探索性数据分析7 
   - 第 \@ref(rvest) 章介绍网页爬虫
