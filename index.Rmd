...
- 基础篇
   ...
   - 第 \@ref(install) 章介绍安装与环境配置 
   - 第 \@ref(objects) 章介绍R语言中一切都是对象
   - 第 \@ref(vectors) 章介绍向量
   - 第 \@ref(data-structure) 章介绍R语言数据结构
   - 第 \@ref(operators) 章介绍运算符及向量运算
   - 第 \@ref(functions) 章介绍R语言中的函数
   - 第 \@ref(subsetting) 章介绍R语言中的子集选取

- tidyverse篇
   - 第 \@ref(rmarkdown) 章介绍可重复性文档
   - 第 \@ref(readr) 章介绍数据读入
   - 第 \@ref(dplyr) 章介绍数据处理
   ...
   - 第 \@ref(ggplot2-geom) 章ggplot2几何图形
   ...
   - 第 \@ref(ggplot2-from-layer-to-geom) 章ggplot2从图层到几何图形
   - 第 \@ref(ggplot2-colors) 章ggplot2数据可视化中的配色
   - 第 \@ref(ggplot2-override-aes) 章ggplot2如何控制图例的外观
   - 第 \@ref(ggplot2-aes-eval) 章介绍ggplot2中的延迟映射 
...
- 建模篇 
   ...
   - 第 \@ref(tidystats) 章介绍t检验、方差分析和重复测量的方差分析等基础统计检验方法
...
- 应用篇
   ...
   - 第 \@ref(Pandas-vs-dplyr) 章Pandas vs. dplyr谁是数据分析中最好用的宏包 
