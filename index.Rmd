...
- tidyverse篇
   ...
   - 第 \@ref(tidyverse-purrr) 章介绍函数式编程
   - 第 \@ref(tidyverse-tibble) 章介绍简单数据框
   - 第 \@ref(tidyverse-ggplot2-geom) 章ggplot2几何图形
   ...
   - 第 \@ref(tidyverse-ggplot2-from-layer-to-geom) 章ggplot2从图层到几何图形
   - 第 \@ref(tidyverse-ggplot2-colors) 章ggplot2数据可视化中的配色
   - 第 \@ref(tidyverse-ggplot2-override-aes) 章ggplot2如何控制图例的外观
   - 第 \@ref(tidyverse-ggplot2-aes-eval) 章介绍ggplot2中的延迟映射 
   ...
   - 第 \@ref(tidyverse-advR) 章介绍Tidyverse进阶技巧
...
- 贝叶斯篇
   ...
   - 第 \@ref(bayesian-vaccine-effectiveness) 章介绍贝叶斯案例-新冠疫苗有效率的计算
