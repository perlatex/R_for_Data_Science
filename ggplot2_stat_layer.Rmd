...
**美学映射**是图形语法中非常重要的一个概念，**变量**映射到**视觉元素**，然后通过几何对象`GEOM`画出图形。（下图是每个几何对象所对应的视觉元素）

```{r ggplot-aesthetics-cheatsheet, out.width = '100%', echo = FALSE, fig.cap = 'ggplot2中的几何对象与美学映射'}
