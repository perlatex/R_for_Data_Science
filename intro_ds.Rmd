...
| 序号 | 内容   |  代码演示   |
|:---|:---|:---|
| 1     |  统计           |   `r xfun::embed_file('./exercises/1_stats.R')` |
| 2     |  可视化         |   `r xfun::embed_file('./exercises/2_visual.R')` |
| 3     |  探索性分析     |   `r xfun::embed_file('./exercises/3_eda.R')` |
| 4     |  可重复性报告   |   `r xfun::embed_file('./exercises/4_reproducible.Rmd')` |
